module.exports = [
"[project]/node_modules/@polar-sh/adapter-utils/dist/index.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
    ...
    handler(slug) {
        return async (payload)=>{
            if (payload.data.benefit.description === slug) {
                switch(payload.type){
                    case "benefit_grant.created":
                        await Promise.all(this.grantCallbacks.map((callback)=>callback({
                        ...
                        break;
                    case "benefit_grant.revoked":
                        await Promise.all(this.revokeCallbacks.map((callback)=>callback({
                                customer: payload.data.customer,
                                properties: payload.data.properties,
                                payload
                            })));
...
"[project]/node_modules/@polar-sh/nextjs/dist/index.js [app-route] (ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
...
// src/webhooks/webhooks.ts
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$polar$2d$sh$2f$adapter$2d$utils$2f$dist$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@polar-sh/adapter-utils/dist/index.js [app-route] (ecmascript)");
...
;
;
var Checkout = ({ accessToken, successUrl, returnUrl, server, theme, includeCheckoutId = true })=>{
    ...
    return async (req)=>{
        ...
        if (configIsExternalCustomerIdConfig(config)) {
            ...
            try {
                ...
                return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].redirect(customerPortalUrl);
            } catch (error) {
                console.error(error);
                return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].error();
            }
...
;
;
var Webhooks = ({ webhookSecret, entitlements, onPayload, ...eventHandlers })=>{
    return async (request)=>{
        ...
        let webhookPayload;
        try {
            webhookPayload = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$polar$2d$sh$2f$sdk$2f$dist$2f$esm$2f$webhooks$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["validateEvent"])(requestBody, webhookHeaders, webhookSecret);
        } catch (error) {
            if (error instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$polar$2d$sh$2f$sdk$2f$dist$2f$esm$2f$webhooks$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["WebhookVerificationError"]) {
                return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                    received: false
                }, {
                    status: 403
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$polar$2d$sh$2f$adapter$2d$utils$2f$dist$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["handleWebhookPayload"])(webhookPayload, {
            webhookSecret,
            entitlements,
            onPayload,
            ...eventHandlers
...
//# sourceMappingURL=node_modules_c639087c._.js.map