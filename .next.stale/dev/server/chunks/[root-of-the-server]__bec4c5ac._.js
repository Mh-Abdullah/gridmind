...
"[project]/app/api/billing/confirm/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    ...
    if (!checkoutId || !packageId) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: "checkoutId and packageId are required."
        }, {
            status: 400
        });
    }
    ...
    try {
        ...
        const result = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$convex$2d$server$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["convexClient"].mutation(__TURBOPACK__imported__module__$5b$project$5d2f$convex$2f$_generated$2f$api$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["api"].billing.grantCreditsFromPolarOrder, {
            userId: user.id,
            packageId: pkg._id,
        ...
        console.error("[Billing confirm] Failed to confirm Polar checkout", {
            checkoutId,
            packageId,
            error
        });
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: "Unable to confirm checkout right now."
        }, {
            status: 500
        });
    }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__bec4c5ac._.js.map