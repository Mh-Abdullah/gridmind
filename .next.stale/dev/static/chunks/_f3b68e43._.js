...
function isSoftDeletedPackage(pkg) {
    return pkg.description?.startsWith("[deleted]") ?? false;
}
    ...
    const handleDeletePackage = async (pkg)=>{
        ...
        try {
            await upsertPackage({
                ...
                name: pkg.name,
                slug: pkg.slug,
                description: `[deleted] ${pkg.description || pkg.name}`,
                credits: Number(pkg.credits),
                internalCostCents: Number(pkg.salePriceCents),
                markupMultiplier: 1,
                polarProductId: pkg.polarProductId || undefined,
                polarSyncedAt: pkg.polarSyncedAt,
                isActive: false,
                isFeatured: false
            });
...
_s(AdminBillingPanel, "20IjJuQ+S9ovg7ByyZmXpCkwFC4=", false, function() {
    return [
...
//# sourceMappingURL=_f3b68e43._.js.map